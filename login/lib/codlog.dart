  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.black, // Cor da AppBar modificada para preto
      ),
      backgroundColor:
          Colors.grey[300], // Cor de fundo modificada para cinza claro
      body: ListView(
        children: <Widget>[
          Padding(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors
                            .black, // Cor do botão Entrar modificada para preto
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors
                            .black, // Cor do botão Cancelar modificada para preto
                        foregroundColor: Colors.white,
                      ),
                      onPressed: _cancelar,
                      child: const Text(
